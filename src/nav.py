...
class MultiNav():
    def __init__(self):
        ...
        locations['1'] = Pose(Point(4.72, 3.72, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['2'] = Pose(Point(0.59, 3.9, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['3'] = Pose(Point(0.377, -0.0768, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        #locations['4'] = Pose(Point(3.59, 3.08, 0.00),
        #                      Quaternion(0.000, 0.000, 2*math.pi, 1.000))
        locations['4'] = Pose(Point(4.43, -0.349, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        ...
        while not rospy.is_shutdown():
            ...
            #if location == '4' :
            #    naving = False
            #    os.system('cd ~/catkin_ws_ee346 && rosrun multinav test.py ')
            #    sys.exit()
